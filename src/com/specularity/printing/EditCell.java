...
/**
 * @author https://gist.github.com/james-d
 * from https://gist.github.com/james-d/be5bbd6255a4640a5357#file-editcell-java
 */
...
public class EditCell<S, T> extends TableCell<S, T> {
    ...
    protected void updateItem(T item, boolean empty) {
        ...
        SetPoint pt = (SetPoint) getTableRow().getItem();
        if(pt == null)
            return;
